...
<span class="section">修改APP最新版本信息</span>
...
<form id="myform" class="form-horizontal form-label-left" method="post"  enctype="multipart/form-data"
            action="${pageContext.request.contextPath }/dev/saveModifyAppversion" novalidate>
  ...
  <div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input class="form-control col-md-7 col-xs-12" id="versionNo"  name="versionNo" value="${appversion.versionNo }" placeholder="请输入版本号" required="required" type="text">
    </div>
  ...
  <div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="number" id="versionSize" name="versionSize" required="required" value="${appversion.versionSize }" placeholder="请输入版本大小，单位为Mb" data-validate-minmax="1,100" class="form-control col-md-7 col-xs-12">
    </div>
  ...
  <div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <textarea id="versionInfo" required="required" name="versionInfo"  placeholder="请输入本版本的相关信息，本信息作为版本的详细信息进行软件的介绍。"  class="form-control col-md-7 col-xs-12"> ${appversion.versionInfo }</textarea>
    </div>
  ...
  <div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12" id="apkFile">
      <input type="file" id="uploadfile" style="display:none;" name="a_apkLocPath" required="required"  class="form-control col-md-7 col-xs-12">
      <input type="hidden" name="downloadLink" id="downloadLink" value="${appversion.downloadLink }"/>
      <input type="hidden" name="apkFileName" id="apkFileName" value="${appversion.apkFileName }"/>
    </div>
  </div>
